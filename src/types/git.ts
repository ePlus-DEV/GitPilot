...
export type CommitInfo={hash:string;shortHash:string;parents:string[];author:string;date:string;message:string;refs:string[];head:boolean;graph:string;insertions:number;deletions:number};
